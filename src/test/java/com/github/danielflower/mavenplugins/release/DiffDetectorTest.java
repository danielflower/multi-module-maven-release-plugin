...
public class DiffDetectorTest {
    ...
    public void canDetectThingsInTheRoot() throws IOException, GitAPIException {
        ...
        AnnotatedTag tag1 = saveFileInModule(simple, ".", "1.0", 1, null);
        ...
        AnnotatedTag tag2 = saveFileInModule(simple, ".", "1.0", 2, null);
    ...
    public void canDetectChangesAfterTheLastTag() throws IOException, GitAPIException {
        ...
        saveFileInModule(project, "console-app", "1.2", 3, null);
        saveFileInModule(project, "core-utils", "2", 0, null);
        AnnotatedTag tag3 = saveFileInModule(project, "console-app", "1.2", 4, null);
